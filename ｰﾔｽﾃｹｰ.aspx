<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="게시물.aspx.cs" Inherits="게시판_만들기" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="auto-style112">
        <tr>
            ...
            <td class="auto-style113" rowspan="2" style="font-family: twayair; font-size: 30px; color: #335195;">여행후기 &nbsp;&nbsp; </td>
    ...
    <p>
                ...
                <asp:Label ID="Label1" runat="server" Font-Names="twayair" Font-Size="20px"></asp:Label>
                        ...
                        <td class="auto-style2">
                            <asp:Label ID="Label4" runat="server" Font-Names="twayair" Font-Size="20px" Text="로그인 된 사용자 이름"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    </tr>
                </table>
            </p>
            ...
            <tr>
                ...
                <td style="border: 4px solid #74739D; background-color: #FFFFFF">
                    <table class="auto-style106" style="background-color: #9999CC">
                        <tr>
                            <td class="auto-style121" style="border-right-style: solid; border-width: 2px; border-color: #9999CC; border-bottom-style: solid; background-color: #FFFFFF;">
                <asp:Label ID="Label2" runat="server" Text="제목 " Font-Names="twayair" Font-Size="22px"></asp:Label>
                            </td>
                            <td class="auto-style122" style="border-bottom-style: solid; border-width: 2px; border-color: #9999CC; border-left-style: solid; background-color: #FFFFFF;">
                <asp:TextBox ID="TextBox1" runat="server" Width="99%" Font-Size="18px" Height="98%" Font-Names="한컴 말랑말랑 Bold" BorderColor="White" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                ...
                <asp:Label ID="Label6" runat="server" Text="작성 시간" Font-Names="twayair" Font-Size="22px"></asp:Label>
                            </td>
                ...
                <asp:Label ID="Label7" runat="server" Font-Names="twayair" Font-Size="18px"></asp:Label>
                            </td>
                        </tr>
                ...
                <asp:TextBox ID="TextBox2" runat="server" Height="99%" TextMode="MultiLine" Width="99%" Font-Names="한컴 말랑말랑 Bold" BorderColor="White" Font-Size="18px" ReadOnly="True" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
